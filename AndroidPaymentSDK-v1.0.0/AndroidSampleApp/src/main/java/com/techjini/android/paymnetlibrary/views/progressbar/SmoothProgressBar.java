...
public class SmoothProgressBar extends ProgressBar {
  ...
  public SmoothProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    final int color = a.getColor(R.styleable.SmoothProgressBar_spb_color, ContextCompat.getColor(context, R.color.spb_default_color));//res.getColor(R.color.spb_default_color));
