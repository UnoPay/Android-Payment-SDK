package com.techjini.android.paymnetlibrary.views.progressbar;
...
import static com.techjini.android.paymnetlibrary.views.progressbar.SmoothProgressBarUtils.checkColors;
import static com.techjini.android.paymnetlibrary.views.progressbar.SmoothProgressBarUtils.checkNotNull;
import static com.techjini.android.paymnetlibrary.views.progressbar.SmoothProgressBarUtils.checkPositive;
import static com.techjini.android.paymnetlibrary.views.progressbar.SmoothProgressBarUtils.checkPositiveOrZero;
import static com.techjini.android.paymnetlibrary.views.progressbar.SmoothProgressBarUtils.checkSpeed;
    ...
    public static class Builder {
        ...
        private void initValues(Context context, boolean editMode) {
            ...
            if (!editMode) {
                ...
                mColors = new int[]{ContextCompat.getColor(context, R.color.fail_text_color)};//res.getColor(R.color.spb_default_color)
